...
class CustomerApi
{
    ...
    /**
     * Operation customerCustomerIdServicesSkuCancelGet
     *
     ...
     */
    public function customerCustomerIdServicesSkuCancelGet($customerId, $sku)
    {
        list($response) = $this->customerCustomerIdServicesSkuCancelGetWithHttpInfo($customerId, $sku);
        return $response;
    }

    /**
     * Operation customerCustomerIdServicesSkuCancelGetWithHttpInfo
     *
     * Cancel customer services
     *
     * @param  string $customerId Bamba customer unique identifier (required)
     ...
     */
    public function customerCustomerIdServicesSkuCancelGetWithHttpInfo($customerId, $sku)
    {
        $request = $this->customerCustomerIdServicesSkuCancelGetRequest($customerId, $sku);
    ...
    /**
     * Operation customerCustomerIdServicesSkuCancelGetAsync
     *
     * Cancel customer services
     *
     * @param  string $customerId Bamba customer unique identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerCustomerIdServicesSkuCancelGetAsync($customerId, $sku)
    {
        return $this->customerCustomerIdServicesSkuCancelGetAsyncWithHttpInfo($customerId, $sku)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customerCustomerIdServicesSkuCancelGetAsyncWithHttpInfo
     *
     * Cancel customer services
     *
     * @param  string $customerId Bamba customer unique identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerCustomerIdServicesSkuCancelGetAsyncWithHttpInfo($customerId, $sku)
    {
        $returnType = '\Bamba\Model\Subscription';
        $request = $this->customerCustomerIdServicesSkuCancelGetRequest($customerId, $sku);
    ...
    /**
     * Create request for operation 'customerCustomerIdServicesSkuCancelGet'
     *
     * @param  string $customerId Bamba customer unique identifier (required)
     * @param  string $sku Service sku (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customerCustomerIdServicesSkuCancelGetRequest($customerId, $sku)
    {
        // verify the required parameter 'customerId' is set
        if ($customerId === null || (is_array($customerId) && count($customerId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customerId when calling customerCustomerIdServicesSkuCancelGet'
            );
        }
        // verify the required parameter 'sku' is set
        if ($sku === null || (is_array($sku) && count($sku) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sku when calling customerCustomerIdServicesSkuCancelGet'
            );
        }
