...
class Service implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['policyNumber'] = $data['policyNumber'] ?? null;
    ...
    {
        return $this->container['policyNumber'];
    }

    /**
     * Sets policyNumber
     *
     * @param string|null $policyNumber The policy number of the customer service, some services does not have it
     *
     * @return self
     */
    public function setPolicyNumber($policyNumber)
    {
        $this->container['policyNumber'] = $policyNumber;
     ...
     * Sets state
     *
     * @param string $state The actual state of the service
     *
     * @return self
     */
     ...
     * Sets validFrom
     *
     * @param \DateTime $validFrom The date and time (ISO 8601 format) of start of validity of the service
     *
     * @return self
     */
     ...
     * Sets validTo
     *
     * @param \DateTime $validTo The date and time (ISO 8601 format) of end of validity of the service
     *
     * @return self
     */
