...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://sandbox.vivebamba.com/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.0.0-beta/PHP';
    ...
    {
        $report  = 'PHP SDK (Bamba) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://sandbox.vivebamba.com/v1",
