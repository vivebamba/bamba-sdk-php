...
*CustomerApi* | [**customerCustomerIdServicesSkuCancelPut**](docs/Api/CustomerApi.md#customercustomeridservicesskucancelput) | **PUT** /customer/{customerId}/services/{sku}/cancel | Cancel customer services
